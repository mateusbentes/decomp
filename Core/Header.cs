namespace Decomp.Core
{
    ...
    {
        public static string Standard { get; set; } = @"# -*- coding: UTF-8 -*-
####################################################################################################################
...
";
        ...
        public static string Shaders { get; set; } = @"# -*- coding: UTF-8 -*-
####################################################################################################################
# Generated by Warband Shader Decompiler
# All rights of the module belong to their respective owners
#
# Shader Decompilation Notes:
# - This file contains the decompiled source code of a shader used in the module.
# - Modifications to this file may require recompilation using the original tools.
####################################################################################################################

";

        public static string Meshes { get; set; } = @"from header_meshes import *
...
meshes = [";
        ...
        public static string Music { get; set; } = @"from header_music import *
####################################################################################################################
...
tracks = [";
        ...
        public static string Icons { get; set; } = @"from header_map_icons import *
...
map_icons = [";
        ...
        public static string ParticleSystems { get; set; } = @"from header_particle_systems import *
...
particle_systems = [";
        ...
        public static string Factions { get; set; } = @"from header_factions import *
...
factions = [";
        ...
        public static string Animations { get; set; } = @"from header_common import *
...
animations = [";
        ...
        public static string Scenes { get; set; } = @"from header_common import *
from header_operations import *
from header_triggers import *
...
scenes = [";
        ...
        public static string InfoPages { get; set; } = @"####################################################################################################################
...
info_pages = [";
        ...
        public static string Postfx { get; set; } = @"from header_postfx import *
...
postfx_params = [";
        ...
        public static string Sounds { get; set; } = @"from header_sounds import *

sounds = [";

        public static string Parties { get; set; } = @"from header_common import *
...
parties = [";
        ...
        public static string PartyTemplates { get; set; } = @"from header_common import *
from header_parties import *
from ID_troops import *
from ID_factions import *
from ID_map_icons import *
...
party_templates = [";
        ...
        public static string Troops { get; set; } = @"import random
...
";
        ...
        public static string Skills { get; set; } = @"from header_common import *
from header_skills import *
...
skills = [";
        ...
        public static string Strings { get; set; } = @"strings = [";

        public static string Quests { get; set; } = @"from header_quests import *
...
quests = [";
        ...
        public static string Skins { get; set; } = @"from header_skins import *
...
skins = [";
        ...
        public static string Scripts { get; set; } = @"from header_common import *
from header_operations import *
from module_constants import *
...
scripts = [";
        ...
        public static string Presentations { get; set; } = @"from header_common import *
from header_presentations import *
from header_mission_templates import *
...
presentations = [";
        ...
        public static string SimpleTriggers { get; set; } = @"from header_common import *
from header_operations import *
from header_parties import *
from header_items import *
from header_skills import *
...
simple_triggers = [";
        ...
        public static string Triggers { get; set; } = @"from header_common import *
from header_operations import *
from header_parties import *
from header_items import *
from header_skills import *
...
triggers = [";
        ...
        public static string SceneProps { get; set; } = @"from header_common import *
...
scene_props = [";
        ...
        public static string TableauMaterials { get; set; } = @"from header_common import *
from ID_animations import *
from header_mission_templates import *
...
tableaus = [";
        ...
        public static string Dialogs { get; set; } = @"from header_common import *
...
dialogs = [";
        ...
        public static string Menus { get; set; } = @"from header_game_menus import *
from header_parties import *
from header_items import *
from header_mission_templates import *
from header_music import *
...
game_menus = [";
        ...
        public static string Items { get; set; } = @"from module_constants import *
from ID_factions import *
from header_items import  *
from header_operations import *
from header_triggers import *
...
items = [";
        ...
        public static string MissionTemplates { get; set; } = @"from header_common import *
from header_operations import *
from header_mission_templates import *
from header_animations import *
from header_sounds import *
...
mission_templates = [";
        ...
        public static string GroundSpecs { get; set; } = @"
...
ground_specs = [";
        ...
        public static string Skyboxes { get; set; } = @"
from module_info import *
sf_day        = 0x00000000
sf_dawn       = 0x00000001
sf_night      = 0x00000002
...
skyboxes = [";
        ...
        public static string Flora { get; set; } = @"import string
from module_info import *
...
fauna_kinds = [";
        ...
        public static string PhysicsMaterials { get; set; } = "physics_materials = [";

        public static string ImprovedShaders { get; set; } = @"shrf_lo_quality   = 0x1000
...
shf_uses_diffuse_map     = 0x100000
shf_uses_diffuse_2_map   = 0x200000
shf_uses_normal_map      = 0x400000
shf_uses_specular_map    = 0x800000
shf_uses_environment_map = 0x1000000
